<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ThongTinMon.aspx.cs" Inherits="TTTT.ThongTinMon" %>
        ...
        <div class="min-vh-100 d-flex align-items-center justify-content-center" style="background-color: #95D2B3;">
            ...
            <h5 class="text-center font-weight-bold mb-4">THÔNG TIN MÓN</h5>
                ...
                <div class="d-flex justify-content-center khung button-container">
                    ...
                    <asp:Button ID="xoa" runat="server" CssClass="btn btn-luu btn-warning text-white mr-2" Text="XÓA" OnClick="Xoa_Click" CausesValidation="false"/>
                </div>
            </div>
        </div>
