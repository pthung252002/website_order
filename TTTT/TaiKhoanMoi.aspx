<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaiKhoanMoi.aspx.cs" Inherits="TTTT.TaiKhoanMoi" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function toggleCheckBoxLists() {
            ...
            var label1 = document.getElementById('<%= Label7.ClientID %>');
            var label2 = document.getElementById('<%= Label6.ClientID %>');
...
<body>
    <form id="form1" runat="server">
        <div class="min-vh-100 d-flex align-items-center justify-content-center" style="background-color: #B2B377;">
            <div class="bg-white rounded-lg shadow p-5 w-100" style="max-width: 32rem;">
                <h5 class="text-center font-weight-bold mb-4">TẠO TÀI KHOẢN MỚI</h5>
                <asp:Label ID="txtThongbao" runat="server" Text=""></asp:Label>
                <div class="khung">
                    <div class="khung5">
                        <asp:Label ID="Label1" runat="server" CssClass="text-secondary" Text="Tên đăng nhập"></asp:Label>
                        <asp:TextBox ID="txtTendangnhap" runat="server" CssClass="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="(*)" ControlToValidate="txtTendangnhap">Tên đăng nhập không được để trống</asp:RequiredFieldValidator>
                    </div>
                    <div>
                        <asp:Label ID="Label2" runat="server" CssClass="text-secondary" Text="Mật khẩu"></asp:Label>
                        <asp:TextBox ID="txtMatkhau" runat="server" CssClass="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="(*)" ControlToValidate="txtMatkhau">Mật khẩu không được để trống</asp:RequiredFieldValidator>
                    </div>
                    <div>
                    ...
                    <div class="d-flex">
                        <div>
                            <asp:Label ID="Label6" runat="server" CssClass="text-secondary" Text="Tài khoản"></asp:Label>
                        ...
                        <div>
                            <asp:Label ID="Label7" runat="server" CssClass="text-secondary" Text="Món"></asp:Label>
                    ...
                    <div class="d-flex justify-content-center button-container khung">
                        <asp:Button ID="luu" runat="server" CssClass="btn btn-luu btn-warning text-white mr-2" Text="TẠO" OnClick="Tao_Click"/>
